...
void dsyrfs(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	lapack_int i = LAPACKE_dsyrfs(LAPACK_ROW_MAJOR, uplo, n, nrhs, a, lda, af, ldaf, ipiv, b, ldb, x, ldx, ferr, berr);
...
void ssyrfs(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	lapack_int i = LAPACKE_ssyrfs(LAPACK_ROW_MAJOR, uplo, n, nrhs, a, lda, af, ldaf, ipiv, b, ldb, x, ldx, ferr, berr);
