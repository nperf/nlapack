...
void dgbequ(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	lapack_int i = LAPACKE_dgbequ(LAPACK_ROW_MAJOR, m, n, kl, ku, ab, ldab, r, c, rowcnd, colcnd, amax);
...
void sgbequ(const v8::FunctionCallbackInfo<v8::Value>& info) {
	...
	lapack_int i = LAPACKE_sgbequ(LAPACK_ROW_MAJOR, m, n, kl, ku, ab, ldab, r, c, rowcnd, colcnd, amax);
